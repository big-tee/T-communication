<section class="newsletter text-center py-5">
        <div class="container py-md-3">
            ...
            <div class="w3l_header_contact_details_agile">
                <p>Give us a Call</p>
                <a class="w3l_header_contact_details_agile-info_inner"> <span><i class="fas fa-phone"></i></span>09056229251</a>
            </div>
            <div class="subscribe_inner">
                <p class="mb-4">We At T-COMMUNICATION We Offer Our Customer The Best Services . </p>
                <div class="social mt-sm-5 mt-3">
                    ...
                    <ul class="d-flex mt-3 justify-content-center">
                        ...
                        <li class="mx-2"><a href="https://wa.me/+2348182162868"><span class="fab fa-whatsapp"></span></a></li>
                    </ul>
                </div>
            </div>
    ...
    <footer>
        <div class="container py-3 py-md-4">
            <div class="footer">
                <p class="text-center">© 2021 T-COMMUNICATION. <!--All Rights Reserved | Design by <a href="http://www.W3Layouts.com" target="_blank">W3Layouts</a>--> </p>
            </div>
        </div>
    </footer>
<!-- //magnific-popup -->
